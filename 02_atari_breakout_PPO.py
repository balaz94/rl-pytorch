...
def learning(num = 1):
    ...
    agent = AgentPPO(0.99, actions, Net(), 0.001, beta_entropy = 0.001, id=num, name='breakout/breakout')
...
def animation():
    ...
    agent = AgentPPO(0.99, actions, Net(), 0.001, beta_entropy = 0.001, id=0, name='breakout/breakout_2_70000_ppo.pt') #breakout/breakout_1_20000_a2c.pt'
    env = make_env('BreakoutNoFrameskip-v4')
    agent.load_model()
