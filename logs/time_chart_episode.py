...
'''
names = ['pong/pong256_3_700_ppo.txt', 'pong/pong512_3_700_ppo.txt', 'pong/pong768_3_700_ppo.txt', 'pong/pong1024_3_700_ppo.txt', 'pong/pong256_2_3_700_ppo.txt', 'pong/pong256_2_4_700_ppo.txt']


for i in range(len(names)):
    d = pd.read_csv(names[i])
    plt.plot(d['episode'], d['score'], color=colors[i], label=names[i])
